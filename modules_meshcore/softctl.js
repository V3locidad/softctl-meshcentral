...
function installWingetSystem(L, cb, bundleUrls) {
    ...
    var script = [
        ...
        'Invoke-WebRequest -Uri $vcUrl -OutFile $vcFile -UseBasicParsing -ProxyUseDefaultCredentials',
        'Write-Output "DL UI.Xaml"',
        'try { Invoke-WebRequest -Uri $xamlUrl -OutFile $xamlFile -UseBasicParsing -ProxyUseDefaultCredentials } catch { Write-Output ("UI.Xaml DL warn: " + $_.Exception.Message); $xamlFile = $null }',
        'Write-Output "DL winget"',
        'Invoke-WebRequest -Uri $wgUrl -OutFile $wgFile -UseBasicParsing -ProxyUseDefaultCredentials',
